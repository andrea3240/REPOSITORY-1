...
int main(void)
{
	...
	insertion_sort(vec_alpha1);
	insertion_sort(vec_alpha2);
	insertion_sort(vec_alpha3);
	insertion_sort(vec_alpha4);
	insertion_sort(vec_alpha5);
	insertion_sort(vec_alpha6);
	insertion_sort(vec_alpha7);
	insertion_sort(vec_alpha8);
	insertion_sort(vec_alpha9);
	insertion_sort(vec_alpha10);
	...
	std::cout << "tutti i vettori numerici e letterali sono stati ordinati correttamente da insertion_sort! \n";
