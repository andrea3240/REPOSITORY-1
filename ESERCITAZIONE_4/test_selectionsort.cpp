...
int main(void)
{
	...
	selection_sort(vec_alpha1);
	selection_sort(vec_alpha2);
	selection_sort(vec_alpha3);
	selection_sort(vec_alpha4);
	selection_sort(vec_alpha5);
	selection_sort(vec_alpha6);
	selection_sort(vec_alpha7);
	selection_sort(vec_alpha8);
	selection_sort(vec_alpha9);
	selection_sort(vec_alpha10);
