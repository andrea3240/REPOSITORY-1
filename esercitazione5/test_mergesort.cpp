...
int main(void)
{
	...
	merge_sort(vec_alpha1);
	merge_sort(vec_alpha2);
	merge_sort(vec_alpha3);
	merge_sort(vec_alpha4);
	merge_sort(vec_alpha5);
	merge_sort(vec_alpha6);
	merge_sort(vec_alpha7);
	merge_sort(vec_alpha8);
	merge_sort(vec_alpha9);
	merge_sort(vec_alpha10);
