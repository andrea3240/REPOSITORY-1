...
int main(void)
{
	...
	quick_sort(vec_alpha1);
	quick_sort(vec_alpha2);
	quick_sort(vec_alpha3);
	quick_sort(vec_alpha4);
	quick_sort(vec_alpha5);
	quick_sort(vec_alpha6);
	quick_sort(vec_alpha7);
	quick_sort(vec_alpha8);
	quick_sort(vec_alpha9);
	quick_sort(vec_alpha10);
